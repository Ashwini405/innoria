...
import { Mail, Lock, User, Utensils, ArrowLeft } from 'lucide-react';
...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-slate-50 flex items-center justify-center px-4 py-12">
